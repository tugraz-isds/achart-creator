...
acreate [--chart] CHART-TYPE [--dataset CSV-FILENAME]
        ...
        [--no-legend] [--no-segment-values] [--no-segment-percentages]
        [--no-tooltips] [--segment-percentage-precision PLACES]
        [--svg-precision PLACES] [--version] [--help]
...
Mandatory arguments:
     ...
     CHART-TYPE                             Specifies the type of the chart to be created.
                                            ...
                                            as the first command-line parameter or,
                                            alternatively, at any position,
                                            prepended by --chart.
...
Optional arguments:
     ...
     --chart-title TITLE                    Specifies a title for the chart which is visible and
     ...
     --target SOFTWARE                      States which assistive software the
                                            ...
                                            for the respective target; in general, all the
